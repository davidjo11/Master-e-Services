...
Tools.include('js/PageBundle.js', function(){ page = new PageBundle();});
Tools.include('js/UserManager.js', function(){ userMan = new UserManager();});
Tools.include('js/User.js', function (){
